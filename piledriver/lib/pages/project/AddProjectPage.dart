...
class PublishTweetPageState extends State<AddProjectPage> {
  ...
  sendTweet(ctx, token) async {
    ...
    try {
      ...
      var request = new MultipartRequest(
          'POST', Uri.parse("http://127.0.0.1:8080/image/uploadimage"));
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("增加新项目", style: new TextStyle(color: Colors.white)),
