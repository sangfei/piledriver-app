...
class TabThreeState extends State<TabThree> with SingleTickerProviderStateMixin {
  ...
  Widget buildOneTabViewHeaderColumn(String header, int columnNumber) {
  ...
  List<Widget> _buildDetailHeader() {
    ...
    widgets.add(buildOneTabViewHeaderColumn('项目', 2));

    insertDiviver(widgets);
    widgets.add(buildOneTabViewHeaderColumn('累计成桩', 4));

    insertDiviver(widgets);
    widgets.add(buildOneTabViewHeaderColumn('时间段内成桩', 4));
  ...
  oneRowOfDetail(i, Color clr, int columnSize) {
    return new Container(
  ...
  _buildRow(int i, StatBean dataTotal, StatBean dataCurrent) {
    widgetList.add(new Container(
      child: new Row(
          ...
          children: <Widget>[
            oneRowOfDetail(
                dataTotal.equipmentname,
                Colors.black,
                2),
            oneRowOfDetail(dataTotal.totalpieces, Colors.black, 4),
            oneRowOfDetail(dataCurrent.pieces, Colors.black, 4),
          ]),
