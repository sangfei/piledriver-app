...
class TabTwo extends StatefulWidget {
  ...
  TabTwo(this.workRegion, this.projectInfo);
...
class TabTwoState extends State<TabTwo> {
      ...
      if (0 == value) {
        ...
        Navigator.pushAndRemoveUntil(context, new MaterialPageRoute<Null>(
          builder: (BuildContext context) {
            return new WorkRegionPage(widget.projectInfo);
          },
        ), (route) => route == null);
      } else {
        showTips();
  ...
  Future getApiData() async {
    var url =
        Constant.baseUrl + '/api/v1/workregion?id=${widget.workRegion.id}';
